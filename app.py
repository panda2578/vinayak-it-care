...
.brand h1{font-size:26px;font-weight:900;line-height:1.1;letter-spacing:0.5px}.brand h1 span{color:#ff7a00}
...
.repair-card{
  border-radius:16px;padding:14px;position:relative;overflow:hidden;min-height:175px;
  border:1px solid rgba(255,255,255,0.1);cursor:pointer;transition:all .4s cubic-bezier(.175,.885,.32,1.275);
}
...
.repair-card:hover img,.repair-card:active img{transform:scale(1.12) rotate(2deg)}
...
.c4{background:linear-gradient(135deg,#7a2e0a 0%,#3d1605 100%);--glow:#f97316}.c4 .icon{background:#c2410c}
.c5{background:linear-gradient(135deg,#0a4a5a 0%,#082a33 100%);--glow:#06b6d4}.c5 .icon{background:#0e7490}
.c6{background:linear-gradient(135deg,#5a4a0a 0%,#2f2605 100%);--glow:#eab308}.c6 .icon{background:#a16207}

/* LOGIN */
.login-box{background:rgba(10,18,35,.95);border:1px solid #23365e;border-radius:16px;padding:18px;position:sticky;top:12px;height:fit-content}
.login-box h3{font-size:14px;margin-bottom:12px}.login-box input{width:100%;padding:11px 12px;border-radius:10px;border:1px solid #1f355c;background:#0d1b31;color:#fff;margin-bottom:10px;font-size:12px}
.btn-login{width:100%;padding:11px;border:none;border-radius:10px;background:linear-gradient(90deg,#ff5a00,#ff8a00);color:#fff;font-weight:800;cursor:pointer}

/* STUDY MATERIAL */
.study-box{margin-top:12px;border:1px solid #1c3156;border-radius:16px;padding:14px;background:rgba(10,18,35,.8);display:grid;grid-template-columns:280px 1fr;gap:12px;align-items:center}
.study-left h3{font-size:16px}.study-left span{font-size:12px;color:#3b9bff}.study-left p{font-size:11px;color:#8aa0c6;margin:6px 0 10px;line-height:1.5}
.study-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}
.thumb-card{cursor:pointer;text-align:center;transition:.35s}
.thumb-img{
  height:88px;border-radius:10px;background:#0c1a2f;border:1px solid #1f355c;
  display:grid;place-items:center;font-size:32px;overflow:hidden;position:relative;transition:all .4s ease;
}
.thumb-card:hover .thumb-img,.thumb-card:active .thumb-img,.thumb-card.m-active .thumb-img{
  transform:scale(1.08) translateY(-4px);border-color:#ff7a00;box-shadow:0 12px 25px rgba(255,122,0,.35),0 0 15px rgba(255,122,0,.3) inset;
}
.thumb-card p{font-size:11px;margin-top:6
